...
public class VideoPlayerActivity extends AppCompatActivity {
        ...
        playPauseIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(videoView.isPlaying()){
                    videoView.pause();
                    playPauseIB.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_play));
                }else{
                    videoView.start();
                    playPauseIB.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_pause));
                }
            }
        });
    ...
    private void initializerSeekBar(){
